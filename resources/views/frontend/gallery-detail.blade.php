...
@section('content')
  ...
  <section class="relative">
    ...
    <div class="flex flex-col space-y-8 ml-10">
      <h3 class="text-4xl font-extrabold text-white">Dashain Tihar WU Customer Promotion Activities</h3>
      <div class="flex space-x-5 items-center">
      <a href="index.html" class="text-[#666] font-bold">Home</a>
      <p class="text-white text-base fony-bold hover:cursor-pointer">></p>
      <a href="gallery-detail" class="text-[#666] font-bold">Gallery</a>
      <p class="text-white text-base fony-bold hover:cursor-pointer">></p>
      <a href="gallery-detail" class="text-accent font-bold">Dashain Tihar WU Customer Promotion Activities</a>
      </div>
    </div>
  </section>
  <!-- banner-section -->
  ...
  <div x-data="{
      ...
      imageGallery: [
        {
          'photo': 'https://grandehospital.com/_next/image?url=https%3A%2F%2Fcms.grandehospital.com%2Fstorage%2FGallery%2F3%2FImages%2F2885_370684019_350716190613408_5349503084462495416_n-1-768x576.jpg&w=828&q=75',
    ...
    <div class="mx-12">
      <h2 class="text-2xl font-bold mb-2">Dashain Tihar WU Customer Promotion Activities</h2>
      <p class="text-gray-600">Explore a collection of breathtaking landscapes. Click on any image to
      view it in full size and experience the beauty of nature.</p>
    </div>
