<div class="row">
    <div class="col-lg-12">
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control @error('map_iframe') is-invalid @enderror" id="map_iframe" name="map_iframe" rows="3">{{ old('map_iframe', $branch->map_iframe ?? '') }}</textarea>
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('display_order') is-invalid @enderror" id="display_order" name="display_order" value="{{ old('display_order', $branch->display_order ?? 0) }}">
            ...
            <div class="col-md-6">
                ...
                <div class="mt-2">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="is_published" name="is_published" value="1" {{ old('is_published', $branch->is_published ?? '1') == '1' ? 'checked' : '' }}>
