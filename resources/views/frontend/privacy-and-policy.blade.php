...
<body class="bg-yellow-400 text-gray-800">
    <div class="max-w-3xl mx-auto p-8 bg-white shadow-lg rounded-lg mt-12">
        ...
        <p class="text-gray-700 mt-2">The personal information you collect from the consumer such as name, address, phone number, legal ID, and account number are private and need to protect from unauthorized access.</p>
        <ul class="list-disc list-inside text-gray-700 mt-2">
            <li>Do not ask for other personal information that you don't need to serve</li>
            <li>Do your best to make sure other do not overhear your conversation and the information beong given to you</li>
        ...
        <ul class="list-disc list-inside text-gray-700 mt-2">
            ...
            <li>ID's, receipts for transaction must be maintained for five(5) years and them promptly and secure destroyed</li>
        </ul>
        ...
        <ul class="list-disc list-inside text-gray-700 mt-2">
            <li> If someone claims to be auditor or from the law enforcement, protect yourself and your coustomer verfying the personal identification</li>
        </UL>
        <h2 class="text-2xl font-semibold mt-6 flex items-center">
            <span class="text-yellow-400 text-lg mr-2">➜</span> BEFORE allowing him/her access to any location re records.
        </h2>
        <ul class="list-disc list-inside text-gray-700 mt-2">
            <li>You cannot release any consumer re transaction information without a subpoena re other written direction from a court re regulatory agency</li>
