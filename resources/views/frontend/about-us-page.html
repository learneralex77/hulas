  ...
  <body>
      ...
      <div class="m-10 flex flex-col gap-6 lg:flex-row  md:justify-center md:items-center">
        <!-- image -->
         <div class="flex-1 flex justify-center m-6">
          <img src="/images/about-us/about-img-1.webp"
          class="rounded-2xl object-cover w-full" alt="" />
         </div>
        ...
        <div class="flex flex-2 flex-col space-y-3">
          ...
          <p> Hulas Remittance, a member company of Golchha Organization, was established in August 2005 with the vision to bring in quality and reliable money transfer services in to Nepal. A leading business house with a dedicated business history of more than 85 years, Golchha Organization has established “HULAS” as one of the most trusted household consumer brands in the country.</p> 
         <p>Hulas Remittance, being one of the principal agents, playing a leading role in offering money transfer services of The Western Union Company in Nepal since January 2006. We have been serving customers from more than 3,200 (comprising of major commercial banks, Development Banks, Finance Companies and cooperative organizations) locations have established brand promise of Western Union as a fast, reliable and convenient way of remittance service across the country.</p>   
        </div>
          <!-- Years of experience -->
          <div
            class="flex flex-col items-center space-y-3 lg:space-y-0 lg:flex-row lg:space-x-4"
          >
          ...
          <div>
            <div class="flex flex-row gap-4 mx-3">
              ...
              >
                ...
                <img src="./public/images/social-media-icons/facebook-black.svg" alt="Facebook Icon" class="w-6 h-6">    
                </a>
              </div>
    ...
    <section class="m-6 sm:m-10 md:m-20 lg:mx-30">
      ...
      <div class="m-10 flex flex-col-reverse gap-6 lg:flex-row  md:justify-center md:items-center">
        ...
        <div class="flex flex-2 flex-col space-y-3">
          ...
          <div class="text-lg text-primary">
          <p> We help aspiring people and businesses around the world save, spend, and transfer money— empowering more prosperous financial futures for their family, friends, and communities across borders.</p>   
        </div>
          <!-- Years of experience -->
          <div
            class="flex flex-col items-center space-y-3 lg:space-y-0 lg:flex-row lg:space-x-4"
    ...
    <section class="mt-12 items-center">
      ...
      >
        ...
        <div
          class="overflow-hidden rounded-lg h-[300px] md:h-[400px] lg:h-[450px] w-full"
        >
          <div
          ...
          >
            ...
            >
              <div class="flex flex-col items-center">
                <img
                  ...
                  class="h-[120px] md:h-[140px] lg:h-[160px] mx-auto"
                />
              ...
              <a
                href="#"
                class="text-[#008391] mt-4 tracking-widest text-center"
                >Read More</a
              >
            </div>
            <div
            ...
            >
              ...
              <a
                href="#"
                class="text-black mt-4 tracking-widest text-center"
                >Read More</a
              >
            </div>
            <div
    ...
    <div class="bg-black py-4">
      ...
      <div class="flex justify-center">
        <button
          class="bg-yellow-300 text-black px-6 py-3 rounded-lg shadow-lg hover:bg-yellow-400"
        >
          Find an Agent
        </button>
      </div>
