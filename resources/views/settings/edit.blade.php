        ...
        <form action="{{ route('settings.update', $setting) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="block block-rounded">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div class="form-text">
                                        Allowed types: JPG, PNG, GIF. Max size: 2MB. Leave empty to keep the current logo.
                                    </div>
                                    @error('logo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div id="primary-logo-preview" class="mt-2">
                                        @if($setting->primary_logo)
                                            <div class="current-image mb-2">
                                                <p class="mb-1">Current Primary Logo:</p>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <div id="secondary-logo-preview" class="mt-2">
                                        @if($setting->secondary_logo)
                                            <div class="current-image mb-2">
                                                <p class="mb-1">Current Secondary Logo:</p>
                ...
                <div class="block-content block-content-full block-content-sm bg-body-light text-center">
                    <button type="submit" class="btn btn-alt-primary">
                        <i class="fa fa-check opacity-50 me-1"></i> Update Settings
                    </button>
                </div>
            </div>
        </form>
