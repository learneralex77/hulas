    ...
    <div class="content">
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Popup Details: {{ $popup->name }}</h3>
                <div class="block-options">
                    <a href="{{ route('popups.edit', $popup->id) }}" class="btn btn-sm btn-alt-primary">
            ...
            <div class="block-content">
                <div class="row">
                        ...
                        <div class="block block-rounded">
                            ...
                            <div class="block-content">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">{{ $popup->name }}</div>
                                </div>
                                <div class="row mb-2">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">{{ $popup->display_order }}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block block-rounded mt-4">
                            ...
                            <div class="block-content">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-8">{{ $popup->created_at->format('M d, Y H:i') }}</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-4 fw-semibold text-muted">Last Updated:</div>
                                    <div class="col-md-8">{{ $popup->updated_at->format('M d, Y H:i') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="block block-rounded">
                            <div class="block-header block-header-default">
                                <h3 class="block-title">Popup Image</h3>
                            </div>
                            <div class="block-content">
                                @if ($popup->image)
                                    <img src="{{ asset('storage/' . $popup->image) }}"
                                        alt="{{ $popup->name }}" class="img-fluid rounded">
                                @else
