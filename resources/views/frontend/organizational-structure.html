...
<html lang="en">
  ...
  <body>
    ...
    <div class="container m-auto px-4 py-12">
      ...
      <div
        class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 ml-8 mr-8"
      >
        <!-- Board Member - 1 -->
        <div
        ...
        >
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5lSFDKzM3JBM8MxUuwN1pwM7uL9b4Kq17bQ&s"
            alt="Luffy"
        ...
        >
          <img
            src="https://cdn.oneesports.gg/cdn-data/2024/04/Anime_OnePiece_Zoro_Sword_Attack.jpg"
            alt="Zorro"
            class="rounded-lg mb-4 w-40 h-40 object-cover"
          />
        ...
        >
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPJY9ctoAR-t6S_PCqdk7FatZyXbU8tpadlg&s"
            alt="Sanzi"
            class="rounded-lg mb-4 w-40 h-40 object-cover"
          />
    ...
    <div class="container mx-auto px-4 py-12 rounded-3xl">
      ...
      <div
        class="grid grid-cols-1 rounded-lg sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 ml-8 mr-8"
      >
        <!-- Team Member - 1 -->
        <div
          class="bg-white rounded-lg shadow-lg p-4 flex flex-col items-center"
