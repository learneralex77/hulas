...
@section('content')
  ...
  <section class="overflow-x-hidden">
    ...
    <div class="flex flex-col items-center space-y-6">
      ...
      Locate your nearest Hulas Remittance agent with ease. Use the table below to find trusted partners ready to help
  ...
  <div class="container mx-auto py-8">
    ...
    <thead>
      ...
      <tr>
      <th><input type="text" class="p-1 m-1 w-36" placeholder="Search Name" /></th>
      <th><input type="text" class="p-1 m-1 w-36" placeholder="Search Position" /></th>
      <th><input type="text" class="p-1 m-1 w-36" placeholder="Search Office" /></th>
      <th><input type="text" class="p-1 m-1 w-36" placeholder="Search Age" /></th>
      <th><input type="text" class="p-1 m-1 w-36" placeholder="Search Start Date" /></th>
      <th><input type="text" class="p-1 m-1 w-36" placeholder="Search Salary" /></th>
      </tr>
    </thead>
    <tbody>
      <tr>
