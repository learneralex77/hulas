  ...
  <body>
    ...
    <section>
      <div class="w-full lg:h-[200px] bg-[#fefff5] py-12 px-8">
        ...
        >
          <img
            src="./img/br-shape-3.png"
            class="spiral absolute top-10 left-96"
            alt=""
          />
          <img
            src="./img/br-shape-4.png"
            class="circle absolute top-20 left-10"
            alt=""
          />
          <img
            src="./img/br-shape-5.png"
            class="semi-circle absolute top-60 right-96"
            alt=""
          />
    ...
    <section class="m-10">
      ...
      <div
        class=" lg:flex lg:justify-center lg:mt-32  w-full"
      >
        <img src="./img/contact-form-bg.png" class="h-full" alt="" />
        <div
          class=" lg:w-[70%] bg-white shadow-xl rounded-md p-6"
        >
          <form class="sm:mx-20">
