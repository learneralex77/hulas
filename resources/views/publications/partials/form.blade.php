    ...
    <div class="col-lg-12">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <input type="number" class="form-control" id="display_order" name="display_order" value="{{ old('display_order', $publication->display_order ?? 0) }}">
            ...
            <div class="col-md-6">
                ...
                <div class="mt-2">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="is_published" name="is_published" value="1" {{ old('is_published', $publication->is_published ?? '1') ? 'checked' : '' }}>
