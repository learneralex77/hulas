...
@section('content')
    ...
    <section class="relative">
        <div class="mb-40">
            <img src="./images/become-an-agent/breadcrumb-serv.jpg" alt="Banner Image" class="h-80 w-full" />
        </div>
    ...
    <section class="flex flex-col m-6 sm:m-10 md:m-20 lg:mx-40">
        ...
        <div class="flex flex-col justify-around lg:flex-row gap-10 rounded-lg">
                    ...
                    <div class="flex flex-col space-y-8">
                        ...
                        <div class="flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-5">
                            ...
                            <div class="flex flex-col space-y-3 w-full">
                                ...
                                <input id="name" placeholder="District" type="text"
            ...
            <div class="flex flex-1 flex-col w-full shadow-xl gap-6 p-6 rounded-lg">
                ...
                <div class="flex flex-col space-y-10 items-left lg:items-center sm:px-10 lg:px-0">
                    <div class="flex flex-row gap-6 space-x-5 items-center">
                        <div class="w-16 h-16 rounded-full bg-accent flex justify-center items-center">
                            <img src="./images/contact/location-pin-svgrepo-com.svg" class="w-8" alt="Location Icon" />
                        </div>
                    ...
                    <div class="flex flex-row gap-6 space-x-5 items-center">
                        <div class="w-16 h-16 rounded-full bg-accent flex justify-center items-center">
                            <img src="./images/contact/phone-svgrepo-com.svg" class="w-8" alt="" />
                        </div>
                    ...
                    <div class="flex flex-row gap-6 space-x-5 items-center">
                        <div class="w-16 h-16 rounded-full bg-accent flex justify-center items-center">
                            <img src="./images/contact/mail-svgrepo-com.png" class="w-8" alt="" />
                        </div>
                        <div class="flex flex-col space-y-2">
                            <p>Email:</p>
                            <p>
