...
<html lang="en">
  <head>
    ...
    <title>Become an agent - Hulas Remittance</title>
  </head>
  <body>
    <div id="navbar"></div>
    ...
    <section class="relative">
      <div class="mb-40">
        <img
          src="./images/become-an-agent/breadcrumb-serv.jpg"
          alt="Banner Image"
          class="h-80 w-full"
        />
      </div>
      <div class="absolute w-full top-20">
        <div class="flex flex-col space-y-8 ml-20">
          <h3 class="text-5xl font-extrabold text-white">Become an agent</h3>
          <div class="flex space-x-5 items-center">
            <a href="index.html" class="text-[#666] font-bold">Home</a>
            <img src="./img/right-arrow.png" class="w-3" alt="" />
            <a href="become-an-agent.html" class="text-accent font-bold">Contact</a>
          </div>
      </div>
    </section>
    <!-- banner-section -->
    ...
    <section class="flex flex-col m-6 sm:m-10 md:m-20 lg:mx-40">
      ...
      <div class="flex flex-col justify-around lg:flex-row gap-10 rounded-lg">
        ...
        <div class="flex flex-2 bg-white shadow-xl rounded-md p-6 w-full">
          <form class="w-full">
            <div class="flex flex-col space-y-8">
              <div
                class="flex flex-col space-y-5 lg:space-y-0 lg:flex-row lg:space-x-5"
              >
                <div class="flex flex-col space-y-3 w-full">
                  ...
                  <input
                    ...
                    placeholder="Name"
                    type="text"
                    class="rounded-md bg-[#f5faff]"
                  />
                </div>

                <div class="flex flex-col space-y-3 w-full">
                  <label for="contact" class="font-bold text-xl text-[#3d5169]"
              ...
              <button
              type="submit"
                class="w-44 flex justify-center items-center bg-[#000] text-bgPrimary hover:text-[#ffc300] py-3 px-5 rounded-full cursor-pointer"
              >
                Submit
              </button>
            </div>
        ...
        <div class="flex flex-1 flex-col w-full shadow-xl gap-6 p-6 rounded-lg">
          ...
          <div
            class="flex flex-col space-y-10 items-left lg:items-center sm:px-10 lg:px-0"
          >
            <div class="flex flex-row gap-6 space-x-5 items-center">
              <div
                class="w-16 h-16 rounded-full bg-accent flex justify-center items-center"
              >
                <img
                  src="./images/contact/location-pin-svgrepo-com.svg"
                  class="w-8"
                  alt="Location Icon"
                />
              </div>
            ...
            <div class="flex flex-row gap-6 space-x-5 items-center">
              ...
              >
                <img
                  src="./images/contact/phone-svgrepo-com.svg"
                  class="w-8"
                  alt=""
                />
              </div>
            ...
            <div class="flex flex-row gap-6 space-x-5 items-center">
              ...
              >
                <img
                  src="./images/contact/mail-svgrepo-com.png"
                  class="w-8"
                  alt=""
                />
              </div>
