    ...
    <div class="content">
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Create Publication</h3>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="news_event_category_id" name="news_event_category_id" required>
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('news_event_category_id') == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="publication_type" name="publication_type" required>
                                        <option value="News" {{ old('publication_type') == 'News' ? 'selected' : '' }}>News</option>
                                        <option value="Article" {{ old('publication_type') == 'Article' ? 'selected' : '' }}>Article</option>
                                        <option value="Event" {{ old('publication_type') == 'Event' ? 'selected' : '' }}>Event</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="published_by" name="published_by" value="{{ old('published_by') }}">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="url" class="form-control" id="external_link" name="external_link" value="{{ old('external_link') }}">
                            ...
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save me-1"></i> Save Publication
                                </button>
                            </div>
                        </div>
                    </div>
