    ...
    <div class="col-lg-10">
        ...
        <div class="mb-4">
            ...
            @if(isset($team) && $team->image)
                <div class="mb-2">
                    <img src="{{ asset('storage/' . $team->image) }}" alt="{{ $team->name }}" class="img-fluid" style="max-height: 200px;">
                </div>
            @endif
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                ...
                <input type="number" class="form-control @error('display_order') is-invalid @enderror" id="display_order" name="display_order" value="{{ old('display_order', $team->display_order ?? 0) }}">
                @error('display_order')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
