                    ...
                    <div class="row push">
                        <div class="col-lg-8 col-xl-5">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control @error('external_link') is-invalid @enderror" id="external_link" name="external_link" value="{{ old('external_link') }}" required>
                                @error('external_link')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-4">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-save"></i> Create Quick Link
                                </button>
                            </div>
                        </div>
                    </div>
