                    ...
                    @foreach ($sliders as $key => $slider)
                        <div class="hidden duration-700 ease-in-out" data-carousel-item="{{ $key === 0 ? 'active' : '' }}">
                            ...
                            <div
                                ...
                                <p class=" text-white text-sm sm:text-lg md:text-2xl max-w-3xl" style="
                                                  -webkit-text-stroke: 1px rgba(19, 18, 18, 0.096);
    ...
    <section class="flex flex-col md:flex-row md:justify-center md:items-center lg:flex-row m-10 md:m-10 2xl:mx-40 gap-10">
        ...
        @isset($aboutUs)
            <div class="flex flex-2 flex-col space-y-6">
                ...
                <a href="{{ route('aboutHulasRemittance') }}"
                    class="text-center text-accent hover:opacity-85 text-md drop-shadow-sm cursor-pointer bg-black px-6 py-2 w-40 rounded-full">
                    Read more
                </a>
            </div>
        @endisset
                ...
                <div class="p-4 md:ml-8 lg:my-4 lg:mx-20 lg:mb-2">
                    <div class="flex flex-col items-center space-y-6">
                        ...
                        <p class="p-2 text-lg text-[#737879] text-center max-w-4xl">
                            Fast, secure money transfers made easy with Hulas Remittance and trusted partners like Western
                            Union.
                        </p>
                    </div>
                </div>
        ...
        <div class="flex flex-col lg:flex-row justify-between items-stretch gap-10">
            ...
            <div class="flex flex-1 flex-col justify-center items-center text-center">
                ...
                <a href="{{ route('becomeAnAgent') }}"
                    class="px-6 py-2 bg-accent text-black border-2 rounded-full hover:opacity-85 font-semibold text-base">
