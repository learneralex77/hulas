...
<div class="row push">
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <input type="number" class="form-control @error('display_order') is-invalid @enderror" id="display_order" name="display_order" value="{{ old('display_order', $download->display_order ?? 0) }}">
                    @error('display_order')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-4">
                    <label class="form-label" for="file">File @if(!isset($download))<span class="text-danger">*</span>@endif</label>
                    ...
                    @endif
                    <input type="file" class="form-control @error('file') is-invalid @enderror" id="file" name="file" {{ !isset($download) ? 'required' : '' }}>
            ...
            <div class="col-md-6">
                <div class="mb-4">
                    ...
                    <div class="form-check form-switch">
                        <input type="checkbox" class="form-check-input" id="is_published" name="is_published" value="1" {{ old('is_published', $download->is_published ?? 1) ? 'checked' : '' }}>
