...
<section id="home-slider">
  ...
  <div class="relative h-80 overflow-hidden rounded-lg md:h-[600px]">
    ...
    <div class="hidden duration-700 ease-in-out" data-carousel-item>
      <img
        src="./images/slider/slider-three.jpg"
    ...
    <div class="hidden duration-700 ease-in-out" data-carousel-item>
      <img
        src="./images/slider/slider-two.jpg"
        class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
        alt="..."
      />
    </div>
...
<section
      class="about flex flex-col xl:flex-row m-10 md:m-20 lg:mx-40 gap-10"
    >
      ...
      <div class="flex flex-1 flex-col space-y-6">
        ...
        <button
          class="m-3 text-left text-accent text-xl uppercase cursor-pointer"
        >
          read more
        </button>
      </div>
  ...
  <div class="space-y-3">
    ...
    <h1 class="text-5xl font-bold">Services</h1>
      ...
      <div
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 space-y-6 gap-3 "
  >
    ...
    <section
      class="about flex flex-col xl:flex-row items-center m-10 md:m-20 lg:mx-40 gap-10"
    >
      <div class="flex flex-1 flex-col space-y-6">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
          ...
          <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
               <!-- Item 1 -->
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="./images/partners/WesternUnion.webp" class="h-40 w-40 absolute block -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Partners Icon" >
              </div>
              <!-- Item 2 -->
              <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="./images/partners/WesternUnion.webp" class="h-40 w-40 absolute block -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Partners Icon" >
    ...
    <div class="flex flex-1 justify-center">
      <ol class="flex flex-col">
        <li class="mb-10 ms-6 flex flex-row gap-4">
          ...
          >
            <img
              src="/images/stepper/tick-svgrepo-com.png"
              alt="Tick Icon"
              class="w-6 h-6"
            />
          </span>
